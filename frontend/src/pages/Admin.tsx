...
export default function Admin() {
  ...
  const [feedbackQ1Label, setFeedbackQ1Label] = useState<string>('Would you recommend BSC Exclusive Davangere to friends & family?');
  ...
  const fetchAdminData = async () => {
    try {
      ...
      if (settingsRes.data?.ok && settingsRes.data.settings) {
        ...
        setFeedbackQ1Label(s.feedbackQ1Label || 'Would you recommend BSC Exclusive Davangere to friends & family?');
